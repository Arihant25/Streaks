...
/**
 * Keeps the app's derived state fresh outside of normal UI flow:
 ...
 *
 * Each run recalculates all streaks (which also refreshes the widget), reschedules every
 * reminder and arms the next midnight refresh.
 */
class RefreshReceiver : BroadcastReceiver() {
    ...
    private fun refresh(context: Context) {
        ...
        ReminderScheduler(context).rescheduleAll(repository.getStreaks())
