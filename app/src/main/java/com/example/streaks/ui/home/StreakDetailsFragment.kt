...
class StreakDetailsFragment : Fragment() {
        ...
        binding.buttonDelete.setOnClickListener {
            AlertDialog.Builder(requireContext())
                    ...
                    .setPositiveButton("Delete") { _, _ ->
                        ...
                        Toast.makeText(requireContext(), "Streak deleted", Toast.LENGTH_SHORT)
                                .show()
                    ...
                    gravity =
                            android.view.Gravity.START or
                                    android.view.Gravity
                                            .BOTTOM // Align to bottom for different text sizes
                    layoutParams =
                            android.widget.LinearLayout.LayoutParams(
                                    android.widget.LinearLayout.LayoutParams.WRAP_CONTENT,
                                    android.widget.LinearLayout.LayoutParams.WRAP_CONTENT
    ...
    private fun getStreakUnit(
            frequency: com.example.streaks.data.FrequencyType,
            count: Int
    ): String {
        ...
        for (week in 0 until totalWeeks) {
            ...
            for (dayOfWeek in 0..6) {
                ...
                if (shouldShowDay) {
                    ...
                    val layoutParams =
                            android.widget.FrameLayout.LayoutParams(dpToPx(32), dpToPx(32))
    ...
    private fun showReminderDialog(binding: FragmentStreakDetailsBinding) {
        var selectedTime =
                reminder?.let { java.time.LocalTime.parse(it.time) } ?: java.time.LocalTime.of(8, 0)
        ...
        val dialog =
                AlertDialog.Builder(requireContext())
                        ...
                        .setPositiveButton("Save") { _, _ ->
                            ...
                            selectedTime =
                                    java.time.LocalTime.of(timePicker.hour, timePicker.minute)
...
class ReminderReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        try {
            ...
            val reminderText =
                    intent.getStringExtra("reminderText") ?: "Time to work on your streak!"
            val builder =
